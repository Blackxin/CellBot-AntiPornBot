        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!('label' in user)) user.label = 'User'
                ...
                if (chat) {
                  ...
                  if (!('antipornbot' in chat)) chat.antipornbot = true
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.sendButton(m.chat, `Ihr Limit ist abgelaufen, bitte kaufen Sie Limits über *${usedPrefix}buy*`, wm, 'Buy', '.buy', m)
            ...
            case 'remove':
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        let pp = 'https://telegra.ph/file/5bcdf8214dfa89e7a2f6a.jpg'
                        try {
                            ...
                            let wel = API('hardianto', '/api/welcome3', {
                                ...
                                bg: 'https://telegra.ph/file/5bcdf8214dfa89e7a2f6a.jpg',
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'Herzlich willkommen' : 'Auf Wiedersehen', action === 'add' ? '+steckbrief' : 'FokusID')
                        }
                    }
                }
                break
...
*+enable delete*`.trim(), wm, 'Matikan Fitur ini', '+enable delete', msg, {
...
global.dfail = async (type, m, conn) => {
    let msg = {
        rowner: `random-api.pics.pyDieser Befehl kann nur von _*Owner*_ genutzt werden!1!1!`,
        owner: `Dieser Befehl kann nur von _*Owner*_ enutzt werden!1!1!`,
        ...
        botAdmin: 'Machen Sie den Bot zu einem *Admin*, um diesen Befehl zu verwenden!',
...
global.thumb = 'https://telegra.ph/file/5bcdf8214dfa89e7a2f6a.jpg'
